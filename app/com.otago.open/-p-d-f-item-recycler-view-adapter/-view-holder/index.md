[app](../../../index.md) / [com.otago.open](../../index.md) / [PDFItemRecyclerViewAdapter](../index.md) / [ViewHolder](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | The [RecyclerView.ViewHolder](#) to bind [PDFItem](../../-p-d-f-item/index.md)s to recycler entries`ViewHolder(itemView: `[`View`](https://developer.android.com/reference/android/view/View.html)`)` |
...
| Name | Summary |
|---|---|
| [bind](bind.md) | Binds a [PDFItem](../../-p-d-f-item/index.md) to a recycler [View](https://developer.android.com/reference/android/view/View.html)`fun bind(item: `[`PDFItem`](../../-p-d-f-item/index.md)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
